...
*/
	...
	x = function(a, b) {
		a = a.split(".");
		for (var c = r,
		d; a.length && (d = a.shift());) a.length || b === void 0 ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] : c = c[d] = {}: c[d] = b
	};
...
*/
	...
	function Ca(a, b) {
		for (var c = a.length,
		d = typeof a === "string" ? a.split("") : a, e = 0; e < c; e++) if (e in d && b.call(void 0, d[e], e, a)) return e;
		return - 1
	};
	...
	f.Vb = function(a, b, c, d) {
		var e = C(this, a);
		if (! (e < 0)) if (b < 0) d && d(new chrome.cast.Error(chrome.cast.v.INVALID_PARAMETER));
		else if (e == b) c && c();
		else {
			var h = null;
			b = b > e ? b + 1 : b;
	...
	var K = function(a, b) {
		...
		} else if (a) if (a instanceof K) for (c = Na(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
	...
	Ta = function(a) {
		...
		a.g && c.set("clientId", a.g); (a = c.toString()) && (b += "?" + a);
		return b
	};
	...
	Va = function(a) {
		var b = a.G.map(function(c) {
			...
			a.C != null && e.set("launchTimeout", String(a.C));
	...
	Za = function(a, b) {
		...
		if (c) return c.statusText = b.statusText,
	...
	Ya = function(a, b) {
		...
		for (c = e.next(); ! c.done; c = e.next()) c = c.value,
		b.hasOwnProperty(c) || (a[c] = null);
		"currentTime" in b && (a.g = Date.now());
		if (a.playerState == chrome.cast.media.A.IDLE && a.loadingItemId == null) a.currentItemId = null,
		a.loadingItemId = null,
		a.preloadedItemId = null,
		a.items = null;
			...
			for (h = b.next(); ! h.done; h = b.next()) {
				...
				if (!h.media) {
					...
					m && m.media ? h.media = m.media: k == a.currentItemId && a.media && (h.media = a.media)
				}
				k = e;
				m = k.push;
				var p = void 0,
	...
	$a = function(a, b) {
		...
		if (a = a.g[b.sessionId]) b = a.media.indexOf(b),
		b != -1 && a.media.splice(b, 1)
	};
	function R() {
		var a = r.navigator;
	...
	db = function(a) {
		if (cb) var b = r.btoa(a);
			...
			a === void 0 && (a = 0);
			if (!S) for (S = {},
			c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), d = ["+/=", "+/", "-_=", "-_.", "-_"], e = 0; e < 5; e++) {
	...
	W = function(a, b, c, d) {
		...
		d = Ra(a.B, b);
		c && d && (a = Qa(a.R, b.sequenceNumber)) && (a = a.g, d = new chrome.cast.Error(chrome.cast.v.INVALID_PARAMETER, d), a && a(d))
	};
	...
	var X = function(a, b) {
		...
		b || Ba(a.g.additionalSessionRequests,
		function(k) {
			h.push({
				appId: k.appId,
	...
	f.ba = function(a) {
		var b = this; (new PresentationRequest(X(this))).reconnect(chrome.cast.bb + a).then(function(c) {
			Y(b, c)
		},
		function() {})
	};
	...
	f.hc = function(a, b) { (a = this.C.get(a)) && a.remove(b)
	};
	f.W = function(a) {
		this.H.push(a)
	};
	...
	f.dc = function(a, b, c) { (a = this.s.get(a)) && (b = a.get(b)) && b.remove(c)
	};
	f.V = function(a, b) {
		jb(this.G, a, b)
	};
	f.Y = function(a, b) { (a = this.G.get(a)) && a.remove(b)
	};
	f.Fb = function(a, b) {
	...
	var gb = function(a, b) {
		if (a.F) {
			...
			Xa(a.I, c, b) && (a.s.delete(c), a.G.delete(c), b = a.C.get(c)) && (a.C.delete(c), G(b.o(),
			function(e) {
				e(d)
			}))
		}
	...
	var lb = function(a, b) { (a = a.C.get(b.sessionId)) && G(a.o(),
		function(c) {
			c(!0)
		})
	},
	...
	mb = function(a, b) { (a = a.s.get(b.sessionId)) && (a = a.get(b.namespaceName)) && G(a.o(),
		function(c) {
